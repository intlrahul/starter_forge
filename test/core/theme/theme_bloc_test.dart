...
void main() {
  ...
  group('ThemeBloc', () {
    ...
    test('LoadTheme event loads system theme when no preference is set', () async {
    ...
    test('UpdateTheme event updates to light theme', () async {
      ...
      expect(themeBloc.state.isDarkMode, equals(false));
      expect(await prefs.getString('appThemeModeBloc'), equals('light'));
    });
    ...
    test('UpdateTheme event updates to dark theme', () async {
      ...
      expect(await prefs.getString('appThemeModeBloc'), equals('dark'));
    });
    ...
    test('UpdateTheme event updates to system theme', () async {
      ...
      expect(themeBloc.state.themeMode, equals(ThemeMode.system));
      expect(themeBloc.state.isDarkMode, equals(false)); // In test environment, system default is light
      expect(await prefs.getString('appThemeModeBloc'), isNull);
    });
  });
} 
